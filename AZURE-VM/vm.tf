resource "aruzerm_resource_group" "resource_group" {
  name = "rg-vm"
...
resource "aruzerm_public_ip" "public_ip" {
  name = "public-ip-terraform"
  resource_group_name = aruzerm_resource_group.resource_group.name
  location = var.location
...
resource "azurerm_network_interface" "network_interface" {
  ...
  ip_configuration {
    ...
    public_ip_address_id = aruzerm_public_ip.public_ip.subnet_id
  }
